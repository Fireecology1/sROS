...
#Import data frame
#fd <- read.csv('Fire_data_jan2023.csv')
#fd <- read.csv('Fire_data_mar2023.csv')  #Schroeder's fires taken out
#fd <- read.csv('Fire_data_apr2023.csv')  #3 PNFI surface fires added
fd <- read.csv('Fire_data_may2023.csv')  #Lower Dewdrop surface fires added
#from FBP database - still more work to add upper Dewdrop; Apr. 27, 2023
...
As operational modelling systems in Canada evolve from fuel-type specific tools (VW 1990, FCFDG 1992) to more flexible formulations suitable for a range of conifer types (CFIS, Perrakis et al. 2023), few tools for surface fires are available.
